...
function SkeletonCard() {
  return (
    <div className="rounded-2xl border border-line bg-surface shadow-[0_1px_2px_rgba(28,30,34,0.05),0_8px_24px_-16px_rgba(28,30,34,0.12)] overflow-hidden">
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex gap-2 pt-2">
          ...
          <div className="h-6 w-14 animate-pulse rounded-full bg-muted/20" />
        </div>
